...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    <asp:Button ID="button_submit" runat="server" Text="Giriş" CssClass="btn" Width="62px" />
        </div>
    </asp:View>
        ...
        <div style="margin-top:5px;">
            ...
            <div style="float:right;"><asp:LinkButton CssClass="lnk" ID="lnkCikisYap" runat="server">Çıkış Yap</asp:LinkButton></div>
